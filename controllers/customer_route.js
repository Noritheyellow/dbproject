...
const addCustomer = (req, res) => {
    ...
    let {customer_id, customer_name, customer_address, customer_birthday, customer_email, customer_phone, customer_job} =
        req.body;
    console.log(customer_id, customer_name, customer_address, customer_birthday, customer_email, customer_phone, customer_job);
